...
public class ItemListAdapter extends RecyclerView.Adapter<ItemListAdapter.ItemListAdapterViewHolder> {
    ...
    public class ItemListAdapterViewHolder extends RecyclerView.ViewHolder{
        ...
        public ItemListAdapterViewHolder(View itemView) {
            super(itemView);
            btnDetail = (Button) itemView.findViewById(R.id.Item_card_btn_ItemDetail);
            img = (ImageView) itemView.findViewById(R.id.item_card_itemImage);
            txtColor = (TextView) itemView.findViewById(R.id.item_card_txt_ItemColor);
            txtName = (TextView) itemView.findViewById(R.id.item_card_txt_itemName);
            txtPrice = (TextView) itemView.findViewById(R.id.item_card_txt_itemPrice);
        }
    }
}
